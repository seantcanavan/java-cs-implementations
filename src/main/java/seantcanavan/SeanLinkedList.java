...
public class SeanLinkedList<E> implements Serializable {
	...
	private static class Node<E> {
		...
		public String toString() {
			...
			if (this.prev == null)
				returnThis.append("begin");
			else
				returnThis.append(this.prev.data);

			returnThis.append(" <- ");
			returnThis.append(this.data);
			returnThis.append(" -> ");
			if (this.next == null)
				returnThis.append("end");
			else
				returnThis.append(this.next.data);
	...
	public E removeFirst() throws NoSuchElementException {
		if (this.size == 0)
			throw new NoSuchElementException("list is empty, can't remove first");
	...
	public E removeLast() throws NoSuchElementException {
		if (this.size == 0)
			throw new NoSuchElementException("list is empty, can't remove last");
